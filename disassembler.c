/*
8080 Disassembler
Written by Lochlan Denholm
*/

/*
General algorithm we will use:

- Read code into buffer.
- Create pointer at beginning of buffer.
- Interpret byte at pointer to determine opcode.
- Print opcode name and its arguments by passing the bytes succeeding
the opcode as data.
- Advance pointer by the opcode instruction size to the next instruction.
...
int Disassemble8080(unsigned char *codebuffer, int pc) {
    ...
    switch (*code) 
    {
        ...
        case 0xc5: printf("PUSH      "); break;
        case 0xc6: printf("ADI      #$%02x", code[1]); opbytes = 2; break;
        case 0xc7: printf("RST      O"); break;
        ...
        case 0xe6: printf("ANI      #$%02x%02x", code[2], code[1]); opbytes = 3; break;
